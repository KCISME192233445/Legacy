...
function showBuy(boxName, boxPrice, boxColor, boxRates) {
  ...
  } else document.getElementById("notEnoughTokensButton").style.display = "none";
...
$('<style>', { id: `cssInject` }).appendTo('#app');
...
function showBoxOpen() {
  ...
  if (blookRarity === "Uncommon") document.getElementById("blookRarity").style.color = `#4bc22e`;
  else if (blookRarity === "Rare") document.getElementById("blookRarity").style.color = `#0a14fa`;
  else if (blookRarity === "Epic") document.getElementById("blookRarity").style.color = `#be0000`;
  else if (blookRarity === "Legendary") document.getElementById("blookRarity").style.color = `#ff910f`;
  else if (blookRarity === "Chroma") document.getElementById("blookRarity").style.color = `#00ccff`;
  else if (blookRarity === "Perfect") document.getElementById("blookRarity").style.color = `#fffacd`;
  else if (blookRarity === "Mystical") document.getElementById("blookRarity").style.color = `#a335ee`;
  else if (blookRarity === "Divine") document.getElementById("blookRarity").style.color = `#ee82ee`;
  else {
